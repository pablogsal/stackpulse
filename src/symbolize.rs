...
impl PerfSymbolizer {
    ...
    fn for_spool_inner(
        ...
        symbolizer.kernel_symbols = Some(load_sparse_kernel_symbols_for_spool(
...
fn load_sparse_kernel_symbols_for_spool(
...
fn load_sparse_kernel_symbols_from_system_map(
    requested_addresses: &[u64],
    rebase_anchors: &[u64],
...
fn kernel_rebase_anchors(modules: &[ModuleRecord]) -> Arc<[u64]> {
...
fn parse_sparse_kernel_symbols_unsorted(
    ...
    let symbols = parse_kernel_symbols(data);
    sparse_kernel_symbols_from_parsed_symbols_rebased(&symbols, requested_addresses, 0)
}
