[![crates.io page](https://img.shields.io/crates/v/framehop-stackpulse.svg)](https://crates.io/crates/framehop-stackpulse)
[![docs.rs page](https://docs.rs/framehop-stackpulse/badge.svg)](https://docs.rs/framehop-stackpulse/)

# framehop-stackpulse

This crate is StackPulse's maintained variant of
[Framehop](https://github.com/mstange/framehop), currently based on Framehop
0.16.0. It preserves Framehop's existing unwinding API and adds the DWARF and
fallback diagnostics needed by StackPulse.
...
Framehop achieves this speed in the following ways:
 ...
 1. It recovers registers needed for stack walking rather than a complete debugger register set. Common unwind rules use `rip`, `rsp` and `rbp` on x86_64, or `lr`, `sp` and `fp` on aarch64. This fork also supports additional x86_64 general-purpose registers when DWARF unwind rules need them.
