...
use crate::unwinder::{Module, Unwinder, UnwinderWithDetails};
use crate::{FrameAddress, UnwindFrameOutcome};
...
impl<D: Deref<Target = [u8]>, P: AllocationPolicy> UnwinderWithDetails for UnwinderX86_64<D, P> {
    ...
    {
        self.0
            .unwind_frame_with_details(address, regs, &mut cache.0, read_stack)
    }
}
